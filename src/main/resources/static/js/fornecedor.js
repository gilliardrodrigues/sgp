...
window.onload = async () => {
	...
	// const observacoes = document.querySelector(".verObservacao");
...
function montarHTMLFornecedor(fornecedor) {
	...
	tabela.innerHTML += `<div class="column ver-obs w12"> <a href="../verObsFornecedor/index.html?id=${fornecedor.id}"> <button type="submit" style="border: 0; background: transparent"> <p>Ver<br>observações</p></button> </a> </div><div class="column edit-fornecedor w8"> <a href="../editarFornecedor/index.html"> <button type="submit" class="edit-button" style="border: 0; background: transparent"> <img src="../../static/img/edit-button.svg" width="20px" alt="submit"/> </button> </a> </div><div class="column delete-button w5 last-column"> <a href=""> <button type="submit" style="border: 0; background: transparent"> <img src="../../static/img/trash-icon.png" width="20px" alt="submit"/> </button> </a> </div>`
