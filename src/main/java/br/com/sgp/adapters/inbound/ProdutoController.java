...
public class ProdutoController {
    ...
    public ResponseEntity<String> listarProdutos() {
        ...
        try {
            return ResponseEntity.ok(inboundPort.buscarTodos());
    ...
    @GetMapping("/canecas")
    public ResponseEntity<List<CanecaResponse>> listarCanecas() {
    ...
    @GetMapping("/tirantes")
    public ResponseEntity<List<TiranteResponse>> listarTirantes() {
    ...
    public ResponseEntity<String> listarInventario() {
        ...
        try {
            return ResponseEntity.ok(inboundPort.buscarInventario());
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public ResponseEntity<String> buscarProdutosPeloIdPedido(@PathVariable Long id) {

        try {
            return ResponseEntity.ok(inboundPort.buscarProdutosPeloIdPedido(id));
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public ResponseEntity<CamisaResponse> alterarCamisa(@Valid @PathVariable Long id,
        ...
        return inboundPort.produtoExiste(id)
                ? ResponseEntity.ok(mapper.mapTo(inboundPort.alterarCamisa(camisa), CamisaResponse.class))
    ...
    public ResponseEntity<CanecaResponse> alterarCaneca(@Valid @PathVariable Long id,
        ...
        caneca.setId(id);
        return inboundPort.produtoExiste(id)
                ? ResponseEntity.ok(mapper.mapTo(inboundPort.alterarCaneca(caneca), CanecaResponse.class))
                : ResponseEntity.notFound().build();
    }
    ...
    public ResponseEntity<TiranteResponse> alterarTirante(@Valid @PathVariable Long id,
        ...
        tirante.setId(id);
        return inboundPort.produtoExiste(id)
                ? ResponseEntity.ok(mapper.mapTo(inboundPort.alterarTirante(tirante), TiranteResponse.class))
                : ResponseEntity.notFound().build();
    }
    ...
    public ResponseEntity marcarChegadaTipoDeProduto(@PathVariable TipoProduto tipoDoProduto) {
        ...
        inboundPort.marcarChegadaTipoDeProduto(tipoDoProduto);
